<template >
  <div class="blogContainer" :style="bgColor">
    <v-cpblogmenu :menuData='getMenuData'></v-cpblogmenu>
    <div class="blogContent">
      原标题：中共中央国务院隆重举行国家科学技术奖励大会 　习近平出席大会并为最高奖获得者等颁奖 李克强讲话　张高丽主持　王沪宁出席

　　新华社北京1月8日电（记者陈芳　吴晶）中共中央、国务院8日上午在北京隆重举行国家科学技术奖励大会。党和国家领导人习近平、李克强、张高丽、王沪宁出席大会并为获奖代表颁奖。李克强代表党中央、国务院在大会上讲话。张高丽主持大会。
...
　　李克强说，要弘扬创新创造精神，提升创新供给能力和效率，促进大众创业万众创新上水平。推动国家重大科研基础设施、科学数据和仪器设备向社会开放。加强知识产权保护。深化国际合作，主动融入全球创新网络，打造世界创新高地。（讲话全文另发）
...
　　国务院副总理刘延东在会上宣读了《国务院关于2017年度国家科学技术奖励的决定》。（决定全文另发）
...
　　2017年度国家科学技术奖共评选出271个项目和9名科技专家。其中，国家最高科学技术奖2人；国家自然科学奖35项，其中一等奖2项、二等奖33项；国家技术发明奖66项，其中一等奖4项、二等奖62项；国家科学技术进步奖170项，其中特等奖3项、一等奖21项（含创新团队3项）、二等奖146项；授予7名外籍科技专家中华人民共和国国际科学技术合作奖。（完）
    </div>
  </div>
</template>
<script>
import { mapActions, mapGetters } from 'vuex'
import cpBlogMenu from '@/components/blog/cpBlogMenu' 
export default {
  data() {
    return {
    }
  ...
  mounted() {
    //setTimeout(this.fetchListData,3000);
    this.fetchListData();
  },
  beforeUpdate() {}
}
